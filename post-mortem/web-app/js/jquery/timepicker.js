...
Timepicker.prototype = {
    init: function()
    {
        ...
        this._colonPos  = -1;
        this._visible   = false;
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible" style="left:'+$("#" + $.datepicker._mainDivId).offset().left + $("#" + $.datepicker._mainDivId).width() +'px; width: 100px; display: none; position: absolute;"></div>');
        this._generateHtml();
    },
