...
<html>
	...
	<body>
		<a href="#edit-alliance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-alliance" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${allianceInstance?.version}" />
				<fieldset class="form">
