...
<script src="${resource(dir:'js/jquery', file:'jquery-1.3.2.js')}" type="text/javascript"></script>
<script src="${resource(dir:'js/jquery', file:'jquery-ui-1.7.2.custom.min.js')}" type="text/javascript"></script>
